...
wait:
				// waiting for ACK || receiving || transmitting || busy channel
...
p_final:
	/// Check the Reed-solomon, print the DATA frame, and send the ACK
	///******************Nov 14, 2014
	//printk("check final...\n");
	//rx_data[10]=0x09;
